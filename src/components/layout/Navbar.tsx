...
import { Menu, X, Zap, Rss, Megaphone, Mic, Gamepad2, Wallet, User, Music, Film, ShoppingBag, Briefcase, ChevronDown } from "lucide-react";
    ...
    <nav className="sticky top-0 z-50 bg-black/95 backdrop-blur-md border-b border-zinc-800">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="font-black text-sm"><span className="text-white">C&C </span><span className="text-yellow-400">Hub〽️</span></span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <div className="relative">
            ...
            {moreOpen && (
              <div className="absolute top-full right-0 mt-1 w-48 bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden shadow-xl">
