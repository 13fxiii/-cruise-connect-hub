...
export default function LoginForm() {
  ...
  const handleXLogin = async () => {
    setXLoading(true);
    setError('');
    // MUST point to /auth/callback — this route exchanges the code for a session
  ...
  return (
    <AuthShell>
      {/* Show URL error from OAuth redirect if any */}
      {searchParams.get('error') && (
        <p className="text-red-400 text-xs bg-red-400/10 border border-red-400/20 rounded-xl p-3 mb-4">
